...
export class StorageHelper {
    ...
    // eslint-disable-next-line sonarjs/cognitive-complexity -- inherit
    ...
    private forEach(callback: (key: string, value: string) => void): void {
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion -- getItem must have something
